    ...
    return (
        ...
        <section className='w-full h-full bg-white mt-12'>
            ...
            <div className='lg:px-6 px-4'>
                ...
                <p className='poppins lg:text-start text-justify mt-2  text-gray-500'>
                ...
                <p className='poppins mt-3 text-gray-500'>
                ...
                <div className='grid lg:grid-cols-4 sm:grid-cols-2 grid-cols-1 gap-7'>
                    {cards.map((item, index) => {
                        return (
                            <div key={index} className='flex flex-col items-center justify-center w-full px-3 py-5 border border-gray-300 my-10 bg-white shadow-md hover:shadow-2xl duration-500 relative group hover:scale-[1.01]'>
